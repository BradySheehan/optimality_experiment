%Code used for generating directories of preprocessed data, including
%natural images, curvature images, and noisy curvature images according to
%paramaters specified. 
function results = preprocess_data()
%===Paramaters===
